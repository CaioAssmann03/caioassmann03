...
Meu objetivo é desenvolver soluções que transformem dados em informações úteis e construir aplicações que resolvam problemas reais.

Estou construindo meu portfólio através de projetos envolvendo automação, APIs, análise de dados e dashboards.
